	...
	'components' => [
		...
		'urlManager' => [
			'rules' => [
				...
				// Standard Pages
				'<action:(home|profile|calendar|account|address|settings|notification|reminder|activity)>' => 'core/user/<action>',
				'<action:(login|logout|register|forgot-password|reset-password|reset-password-otp|activate-account|confirm-account|feedback|testimonial|terms|privacy|faqs|maintenance)>' => 'core/site/<action>'
			]
		],
		'core' => [
