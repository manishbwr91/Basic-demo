...
function initVelocitySliders() {
	...
	// Components Slider
	jQuery( '.cmt-slider-component' ).cmtSlider({
		lControlContent: '<i class=\"cmti cmti-chevron-left  valign-center\"></i>',
		rControlContent: '<i class=\"cmti cmti-chevron-right  valign-center\"></i>',
		height: 1500,
		width: 1500,
		autoScroll: true,
		lightbox: true
