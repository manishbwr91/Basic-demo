<span cmt-app="notify" cmt-controller="notification" cmt-action="toggleRead" action="notify/notification/toggle-read?id=<?= $model->id ?>">
	...
	<span class="text text-blue padding padding-right-medium cmt-click cmti <?= $model->isConsumed() ? 'cmti-envelope-o' : 'cmti-envelope' ?>" title="<?= $model->isConsumed() ? 'Mark Unread' : 'Mark Read' ?>"></span>
</span>
