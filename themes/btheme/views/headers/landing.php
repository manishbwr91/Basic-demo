<header class="landing-page-header">
	<div class="header header-basic header-fixed">
		<div class="row">
			...
			<ul id="menu-main" class="nav">
				...
				<li class="header-icon"><a><span popup="landing-popup" class="popup-trigger"><i class="cmti cmti-2x cmti-user-c-o text text-white pointer"></i></span></a></li>
			</ul>
			<div id="landing-popup" class="cmt-popup popup popup-basic popup-modal">
			...
			<div id="mobile-actions">
				<span id="btn-menu-mobiles" class="mobile-action">
					<i class="cmti cmti-1x cmti-menu cmti-action"></i>
				</span>
			</div>
		</div>
