...
$this->title 	= 'Terms & Conditions | ' . $coreProperties->getSiteTitle();
$resourceUrl	= $coreProperties->getResourceUrl();

// Breadcrumbs
$this->context->breadcrumbs	= [
	'base' => [ [ 'label' => 'Home', 'url' =>  Url::toRoute( [ '/home' ], true ) ] ],
	'all' => [ [ 'label' => 'Terms & Conditions' ] ]
];
?>
<div class="page page-basic page-default page-terms" data-slug="terms" cmt-block="block-half-auto">
	<div class="page-content-wrap">
		<div class="page-header-wrap page-header-banner">
			...
			<div class="page-header page-header-scroll valign-center">
				<div class="page-header-title">Terms & Conditions</div>
			</div>
		</div>
