    ...
    grunt.initConfig({
		...
		sass: {
			dist: {
				...
				files: {
					'../../../backend/web/styles/pubazxrs-20190716-src.css': '../../../themes/admin/resources/styles/scss/public.scss',
					'../../../backend/web/styles/prvazxrs-20190716-src.css': '../../../themes/admin/resources/styles/scss/private.scss'
				}
			}
		},
        concatCssCommon: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/styles/cmnazxrs-20190716-src.css'
      		}
    	},
        concatCssChild: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/styles/chdazxrs-20190716-src.css'
      		}
    	},
        concatJsCommon: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/scripts/cmnazxrs-20190716-src.js'
      		}
    	},
        concatJsPublic: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/scripts/pubazxrs-20190716-src.js'
      		}
    	},
        concatJsPrivate: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/scripts/prvazxrs-20190716-src.js'
      		}
    	},
        concatJsChild: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../backend/web/scripts/chdazxrs-20190716-src.js'
      		}
    	},
    	cssmin: {
			options: {
      		...
      		target: {
	        	files: {
					'../../../backend/web/styles/cmnazxrs-20190716.css': [ '../../../backend/web/styles/cmnazxrs-20190716-src.css' ],
	          		'../../../backend/web/styles/pubazxrs-20190716.css': [ '../../../backend/web/styles/pubazxrs-20190716-src.css' ],
					'../../../backend/web/styles/prvazxrs-20190716.css': [ '../../../backend/web/styles/prvazxrs-20190716-src.css' ],
					'../../../backend/web/styles/chdazxrs-20190716.css': [ '../../../backend/web/styles/chdazxrs-20190716-src.css' ]
	        	}
      		}
    	},
    	uglify: {
			options: {
      		...
      		main_target: {
	        	files: {
	          		'../../../backend/web/scripts/cmnazxrs-20190716.js': [ '../../../backend/web/scripts/cmnazxrs-20190716-src.js' ],
					'../../../backend/web/scripts/pubazxrs-20190716.js': [ '../../../backend/web/scripts/pubazxrs-20190716-src.js' ],
					'../../../backend/web/scripts/prvazxrs-20190716.js': [ '../../../backend/web/scripts/prvazxrs-20190716-src.js' ],
					'../../../backend/web/scripts/chdazxrs-20190716.js': [ '../../../backend/web/scripts/chdazxrs-20190716-src.js' ]
	        	}
      		}
    	},
		copy: {
