    ...
    grunt.initConfig({
		...
		sass: {
			dist: {
				...
				files: {
					'../../../frontend/web/basic/ladcmgbi-20190716-src.css': '../../../themes/basic/resources/styles/scss/landing.scss',
					'../../../frontend/web/basic/pubcmgbi-20190716-src.css': '../../../themes/basic/resources/styles/scss/public.scss',
					'../../../frontend/web/basic/prvcmgbi-20190716-src.css': '../../../themes/basic/resources/styles/scss/private.scss'
				}
			}
		},
        concatFa: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/fawcmgbi-20190716-src.css'
      		}
    	},
        concatCssCommon: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/cmncmgbi-20190716-src.css'
      		}
    	},
        concatCssLanding: {
      		options: {
      		...
      		dist: {
        		src: [
					'../../../frontend/web/basic/ladcmgbi-20190716-src.css'
				],
        		dest: '../../../frontend/web/basic/ladcmgbi-20190716-src.css'
      		}
    	},
        concatCssPublic: {
      		options: {
      		...
      		dist: {
        		src: [
					...
					'../../../frontend/web/basic/pubcmgbi-20190716-src.css'
				],
        		dest: '../../../frontend/web/basic/pubcmgbi-20190716-src.css'
      		}
    	},
        concatCssPrivate: {
      		options: {
      		...
      		dist: {
        		src: [
					...
					'../../../frontend/web/basic/prvcmgbi-20190716-src.css'
				],
        		dest: '../../../frontend/web/basic/prvcmgbi-20190716-src.css'
      		}
    	},
        concatJsLazy: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/lzycmgbi-20190716-src.js'
      		}
    	},
        concatJsCommon: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/cmncmgbi-20190716-src.js'
      		}
    	},
        concatJsLanding: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/ladcmgbi-20190716-src.js'
      		}
    	},
        concatJsPublic: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/pubcmgbi-20190716-src.js'
      		}
    	},
        concatJsPrivate: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/basic/prvcmgbi-20190716-src.js'
      		}
    	},
    	cssmin: {
			options: {
      		...
      		target: {
	        	files: {
					'../../../frontend/web/basic/fawcmgbi-20190716.css': [ '../../../frontend/web/basic/fawcmgbi-20190716-src.css' ],
					'../../../frontend/web/basic/cmncmgbi-20190716.css': [ '../../../frontend/web/basic/cmncmgbi-20190716-src.css' ],
	          		'../../../frontend/web/basic/ladcmgbi-20190716.css': [ '../../../frontend/web/basic/ladcmgbi-20190716-src.css' ],
					'../../../frontend/web/basic/pubcmgbi-20190716.css': [ '../../../frontend/web/basic/pubcmgbi-20190716-src.css' ],
					'../../../frontend/web/basic/prvcmgbi-20190716.css': [ '../../../frontend/web/basic/prvcmgbi-20190716-src.css' ]
	        	}
      		}
    	},
    	uglify: {
			options: {
      		...
      		main_target: {
	        	files: {
					'../../../frontend/web/basic/lzycmgbi-20190716.js': [ '../../../frontend/web/basic/lzycmgbi-20190716-src.js' ],
	          		'../../../frontend/web/basic/cmncmgbi-20190716.js': [ '../../../frontend/web/basic/cmncmgbi-20190716-src.js' ],
					'../../../frontend/web/basic/ladcmgbi-20190716.js': [ '../../../frontend/web/basic/ladcmgbi-20190716-src.js' ],
					'../../../frontend/web/basic/pubcmgbi-20190716.js': [ '../../../frontend/web/basic/pubcmgbi-20190716-src.js' ],
					'../../../frontend/web/basic/prvcmgbi-20190716.js': [ '../../../frontend/web/basic/prvcmgbi-20190716-src.js' ]
	        	}
      		}
    	},
		copy: {
