...
class m181018_026621_slider extends \cmsgears\core\common\base\Migration {
	...
	private function insertFiles() {
		...
		$files = [
			...
			[ 104005, $site->id, $master->id, $master->id, 'back-main-2', NULL, 'back-main', '', 'jpg', 'gallery', 0.1373, 1500, 'image', NULL, '2019-11-05/gallery/back-main-2.jpg', '2019-11-05/gallery/back-main-2-medium.jpg', '2019-11-05/gallery/back-main-2-small.jpg', '2019-11-05/gallery/back-main-2-thumb.jpg', '2019-11-05/gallery/back-main-2-pl.jpg', '2019-11-05/gallery/back-main-2-small-pl.jpg', NULL, NULL, NULL, NULL, NULL, 0, '1920,1152,576', '(max-width: 1920px) 100vw, 1920px', DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, NULL, NULL, 0, NULL ],
			[ 104006, $site->id, $master->id, $master->id, 'back-main-3', NULL, 'back-main', '', 'jpg', 'gallery', 0.1373, 1500, 'image', NULL, '2019-11-05/gallery/back-main-3.jpg', '2019-11-05/gallery/back-main-3-medium.jpg', '2019-11-05/gallery/back-main-3-small.jpg', '2019-11-05/gallery/back-main-3-thumb.jpg', '2019-11-05/gallery/back-main-3-pl.jpg', '2019-11-05/gallery/back-main-3-small-pl.jpg', NULL, NULL, NULL, NULL, NULL, 0, '1920,1152,576', '(max-width: 1920px) 100vw, 1920px', DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, NULL, NULL, 0, NULL ]
			];
	...
	private function insertSlider() {
		...
		$slides = [
			[100001, 10001, 102001, 'Demo Title', '', '', '', 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry' ],
			//[100002, 10001, 102002, 'Slide 2', '', '', '', 0, '' ],
			//[100003, 10001, 102003, 'Slide 3', '', '', '', 0, '' ],
			//[1000001, 10001, 102005, 'Slide 4', '', '', '', 0, '' ],
			[1000002, 10001, 104005, 'Demo Title', 'Demo Title', '', '', 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry' ],
			[1000003, 10001, 104006, 'Demo Title', 'Demo Title', '', '', 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry' ],
		];
