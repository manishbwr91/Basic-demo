...
class m181019_046641_objects extends \cmsgears\core\common\base\Migration {
	...
	private function insertFiles() {
		...
		$files = [
			...
			[ 104004, $site->id, $master->id, $master->id, 'buildings', NULL, 'buildings', '', 'jpg', 'banner', 0.3496, 1500, 'image', NULL, '2019-10-21/banner/buildings.jpg', '2019-10-21/banner/buildings-medium.jpg', '2019-10-21/banner/buildings-small.jpg', '2019-10-21/banner/buildings-thumb.jpg', '2019-10-21/banner/buildings-pl.jpg', '2019-10-21/banner/buildings-small-pl.jpg', NULL, NULL, NULL, NULL, NULL, 0, '1600,960,480', '(max-width: 1600px) 100vw, 1600px', DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, NULL, NULL, 0, NULL ]
		];
	...
	private function insertTemplates() {
		...
		$templates = [
			...
			[ 101003, $master->id, $master->id, 'Easy Customisation', 'easy-customisation', 'element', null, null, true, 'Default layout for easy elements.', null, null, null, null, null, null, null, 'templates\models\core\settings\ElementSettings', '@templates/core/element/card/default/forms', 'default', true, null, false, '@templates/core/element/easyCustomisation/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, null, null ],
			[ 101004, $master->id, $master->id, 'Easy Customisation2', 'easy-customisation2', 'element', null, null, true, 'Default layout for easy elements.', null, null, null, null, null, null, null, 'templates\models\core\settings\ElementSettings', '@templates/core/element/card/default/forms', 'default', true, null, false, '@templates/core/element/easyCustomisation2/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, null, null ],
			// Block Templates
			[ 101005, $master->id, $master->id, 'Default', CoreGlobal::TEMPLATE_DEFAULT, 'block', null, null, true, 'Default layout for blocks.', null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@templates/core/block/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ 101006, $master->id, $master->id, 'Max', 'max', 'block', null, null, true, 'Default layout for max blocks.', null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@templates/core/block/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-max" }', null, null ],
			[ 101007, $master->id, $master->id, 'Testimonial', 'testimonial', 'block', null, null, true, 'Testimonial layout for blocks showing testimonials.', null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@templates/core/block/testimonial', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-max block-testimonial" }', null, null ],
			[ 101008, $master->id, $master->id, 'FoxSlider', 'foxslider', 'block', null, null, true, 'FoxSlider layout for blocks showing slider. The block slug must be same as that of foxslider.', null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@templates/core/block/foxslider', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-max block-max-buffer block-foxslider" }', null, null ],
			[ 101009, $master->id, $master->id, 'basic', 'basic', 'block', null, null, true, null, null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@themeTemplates/block/basic', null, DateUtil::getDateTime(), DateUtil::getDateTime(), null, null, null ],
			[ 101010, $master->id, $master->id, 'about', 'about', 'block', null, null, true, null, null, null, null, null, null, null, null, 'templates\models\core\settings\BlockSettings', '@templates/core/block/default/forms', 'default', true, null, false, '@themeTemplates/block/about', null, DateUtil::getDateTime(), DateUtil::getDateTime(), null, null, null ],
		];
	...
	private function insertElements() {
		...
		$easy1Element	= Template::findGlobalBySlugType( 'easy-customisation', CoreGlobal::TYPE_ELEMENT );
		$easy2Element	= Template::findGlobalBySlugType( 'easy-customisation2', CoreGlobal::TYPE_ELEMENT );
		...
		$elements = [
			...
			[ 10004, $site->id, NULL, $easy1Element->id, NULL, NULL, NULL, NULL, $master->id, $master->id, 'Easy Customisation1', 'easy-customisation1', 'element', 'icon', 'texture', 'Easy Customistion title1', NULL, NULL, NULL, 16000, 1500, 0, 0, 0, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box-basic" }','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', NULL, '{"settings":{"defaultAvatar":"0","lazyAvatar":"0","resAvatar":"0","defaultBanner":"0","lazyBanner":"0","resBanner":"0","bkg":"0","bkgClass":"","bkgVideo":"0","texture":"0","header":"1","headerIcon":"1","headerTitle":"1","headerInfo":"1","headerContent":"1","headerIconUrl":"","content":"0","contentTitle":"0","contentInfo":"0","contentSummary":"0","contentData":"0","contentRaw":"","maxCover":"0","contentClass":"","contentDataClass":"","styles":"","scripts":"","footer":"0","footerIcon":"0","footerIconClass":null,"footerIconUrl":"","footerTitle":"0","footerTitleData":"","footerInfo":"0","footerInfoData":"","footerContent":"0","footerContentData":"","metas":"0","metaType":"","metaWrapClass":"","purifySummary":"1","purifyContent":"1"}}', NULL, 0, NULL ],
			[ 10005, $site->id, NULL, $easy1Element->id, NULL, NULL, NULL, NULL, $master->id, $master->id, 'Easy Customisation2', 'easy-customisation2', 'element', 'icon', 'texture', 'Easy Customistion title2', NULL, NULL, NULL, 16000, 1500, 0, 0, 0, DateUtil::getDateTime(), DateUtil::getDateTime(),'{ "class": "box-basic" }','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', NULL, '{"settings":{"defaultAvatar":"0","lazyAvatar":"0","resAvatar":"0","defaultBanner":"0","lazyBanner":"0","resBanner":"0","bkg":"0","bkgClass":"","bkgVideo":"0","texture":"0","header":"1","headerIcon":"1","headerTitle":"1","headerInfo":"1","headerContent":"1","headerIconUrl":"","content":"0","contentTitle":"0","contentInfo":"0","contentSummary":"0","contentData":"0","contentRaw":"","maxCover":"0","contentClass":"","contentDataClass":"","styles":"","scripts":"","footer":"0","footerIcon":"0","footerIconClass":null,"footerIconUrl":"","footerTitle":"0","footerTitleData":"","footerInfo":"0","footerInfoData":"","footerContent":"0","footerContentData":"","metas":"0","metaType":"","metaWrapClass":"","purifySummary":"1","purifyContent":"1"}}', NULL, 0, NULL ],
			[ 10006, $site->id, NULL, $easy1Element->id, NULL, NULL, NULL, NULL, $master->id, $master->id, 'Easy Customisation3', 'easy-customisation3', 'element', 'icon', 'texture', 'Easy Customistion title3', NULL, NULL, NULL, 16000, 1500, 0, 0, 0, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box-basic" }','Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', NULL, '{"settings":{"defaultAvatar":"0","lazyAvatar":"0","resAvatar":"0","defaultBanner":"0","lazyBanner":"0","resBanner":"0","bkg":"0","bkgClass":"","bkgVideo":"0","texture":"0","header":"1","headerIcon":"1","headerTitle":"1","headerInfo":"1","headerContent":"1","headerIconUrl":"","content":"0","contentTitle":"0","contentInfo":"0","contentSummary":"0","contentData":"0","contentRaw":"","maxCover":"0","contentClass":"","contentDataClass":"","styles":"","scripts":"","footer":"0","footerIcon":"0","footerIconClass":null,"footerIconUrl":"","footerTitle":"0","footerTitleData":"","footerInfo":"0","footerInfoData":"","footerContent":"0","footerContentData":"","metas":"0","metaType":"","metaWrapClass":"","purifySummary":"1","purifyContent":"1"}}', NULL, 0, NULL ],
	...
	private function insertBlocks() {
		...
		$basicBlock	= Template::findGlobalBySlugType( 'basic', CoreGlobal::TYPE_BLOCK );
		$aboutBlock	= Template::findGlobalBySlugType( 'about', CoreGlobal::TYPE_BLOCK );
	...
	private function insertMappings() {
		...
		$mappings = [
			[ 100004, 10004, 10202, CoreGlobal::TYPE_BLOCK, CoreGlobal::TYPE_ELEMENT, NULL, 0, 1, 0, 0, NULL ],
			[ 100005, 10005, 10202, CoreGlobal::TYPE_BLOCK, CoreGlobal::TYPE_ELEMENT, NULL,  0, 1, 0, 0, NULL ],
			[ 100006, 10006, 10202, CoreGlobal::TYPE_BLOCK, CoreGlobal::TYPE_ELEMENT, NULL, 0, 1, 0, 0, NULL ]
		];
